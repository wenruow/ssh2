...
public class Recommendation {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((reciever == null) ? 0 : reciever.hashCode());
	...
	public Recommendation(int id, User sender, User reciever, String title,
			String content, Date sendDateTime, Mail reply, Book bookId) {
		super();
		this.id = id;
		this.sender = sender;
		this.reciever = reciever;
